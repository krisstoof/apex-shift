...
| Options/settings | `ported` | UX styling only |
...
| Resource regrowth | `partial` | [`Assets/_Project/Scripts/Runtime/Resources/ResourceNodeView.cs`](../../Assets/_Project/Scripts/Runtime/Resources/ResourceNodeView.cs), [`Assets/_Project/Scripts/Runtime/Resources/ResourceRegistry.cs`](../../Assets/_Project/Scripts/Runtime/Resources/ResourceRegistry.cs), [`Assets/_Project/Scripts/Tests/Unit/Resources/ResourceRegrowthSystemTests.cs`](../../Assets/_Project/Scripts/Tests/Unit/Resources/ResourceRegrowthSystemTests.cs) | #9, #27, #46, #82 | Runtime regrowth iteration uses the typed resource registry; the logical regrowth model remains covered separately. |
...
| World query / spatial lookup | `partial` | [`Assets/_Project/Scripts/Runtime/World/Query/WorldQueryRuntime.cs`](../../Assets/_Project/Scripts/Runtime/World/Query/WorldQueryRuntime.cs), [`Assets/_Project/Scripts/Tests/Unit/World/WorldQueryRuntimeTests.cs`](../../Assets/_Project/Scripts/Tests/Unit/World/WorldQueryRuntimeTests.cs) | #26, #46, #82 | A stable registry-backed query facade serves creature radius and nearest lookups; a spatial index remains future work. |
...
| Debug panel | `ported` | [`Assets/_Project/Scripts/Presentation/Debugging/RuntimeDiagnosticsBootstrap.cs`](../../Assets/_Project/Scripts/Presentation/Debugging/RuntimeDiagnosticsBootstrap.cs), [`Assets/_Project/Scripts/Presentation/Debugging/DebugPanelPresenter.cs`](../../Assets/_Project/Scripts/Presentation/Debugging/DebugPanelPresenter.cs), [`Assets/_Project/Scripts/Presentation/Debugging/WorldMapDebugWindow.cs`](../../Assets/_Project/Scripts/Presentation/Debugging/WorldMapDebugWindow.cs), [`Assets/_Project/Scripts/Runtime/Creatures/CreatureDebugOverlay.cs`](../../Assets/_Project/Scripts/Runtime/Creatures/CreatureDebugOverlay.cs) | #15, #33, #40, #85 | Developer diagnostics are owned by the presentation bootstrap and gated to Editor/development builds. |
...
| Options/settings | `ported` | [`Assets/_Project/Scripts/Runtime/Settings/GameSettingsData.cs`](../../Assets/_Project/Scripts/Runtime/Settings/GameSettingsData.cs), [`Assets/_Project/Scripts/Runtime/Settings/GameSettingsService.cs`](../../Assets/_Project/Scripts/Runtime/Settings/GameSettingsService.cs), [`Assets/_Project/Scripts/Runtime/Settings/GameSettingsBootstrap.cs`](../../Assets/_Project/Scripts/Runtime/Settings/GameSettingsBootstrap.cs), [`Assets/_Project/Scripts/Runtime/Settings/AudioSettingsRuntime.cs`](../../Assets/_Project/Scripts/Runtime/Settings/AudioSettingsRuntime.cs), [`Assets/_Project/Scripts/Presentation/HUD/OptionsMenuController.cs`](../../Assets/_Project/Scripts/Presentation/HUD/OptionsMenuController.cs), [`Docs/settings/options-menu-foundation.md`](../settings/options-menu-foundation.md) | #59 | Audio and graphics settings foundation exists. Remaining work is final UI styling, authored prefabs and platform-specific settings. |
| Survival loop | `partial` | [`Assets/_Project/Scripts/Runtime/Player/PlayerSurvivalRuntime.cs`](../../Assets/_Project/Scripts/Runtime/Player/PlayerSurvivalRuntime.cs), [`Assets/_Project/Scripts/Runtime/Player/PlayerInventoryRuntime.cs`](../../Assets/_Project/Scripts/Runtime/Player/PlayerInventoryRuntime.cs), [`Assets/_Project/Scripts/Runtime/Player/PlayerDeathRuntime.cs`](../../Assets/_Project/Scripts/Runtime/Player/PlayerDeathRuntime.cs), [`Assets/_Project/Scripts/Core/Survival/SurvivalSystem.cs`](../../Assets/_Project/Scripts/Core/Survival/SurvivalSystem.cs), [`Assets/_Project/Scripts/Core/Survival/SurvivalStats.cs`](../../Assets/_Project/Scripts/Core/Survival/SurvivalStats.cs), [`Assets/_Project/Scripts/Runtime/Buildings/BuildingPlacementRuntime.cs`](../../Assets/_Project/Scripts/Runtime/Buildings/BuildingPlacementRuntime.cs) | #41, #59, #71 | Hunger, edible items, fatigue/exhaustion, death/game-over and tent placement/crafting foundations exist. Remaining work is sleep-in-tent polish, balance, UI polish and edge cases. |
